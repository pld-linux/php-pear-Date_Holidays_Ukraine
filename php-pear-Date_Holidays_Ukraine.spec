...
%define		_class		Date
%define		_subclass	Holidays_Ukraine
%define		_status		alpha
%define		_pearname	Date_Holidays_Ukraine
...
# Source0-md5:	e57428fa381649172eecee3f63997361
...
specjalnych okazji. Klasa ta pozwala na wyliczenie świąt ukraińskich.
...
%{php_pear_dir}/Date/Holidays/Driver/Ukraine.php

%files tests
%defattr(644,root,root,755)
%{php_pear_dir}/tests/Date_Holidays_Ukraine
